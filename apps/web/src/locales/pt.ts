...
const pt: Dict = {
  ...
  'The words say {a}, but the amount is set to {b}. Both sides sign the words — fix the sentence, or the number.':
    'O texto diz {a}, mas o valor está em {b}. Os dois lados assinam o texto: corrija a frase ou o número.',
  ...
  'Second half — {line}': 'Segunda metade — {line}',
  ...
  Sent: 'Enviado',
  'A question was asked': 'Foi feita uma pergunta',
  'The question was answered': 'A pergunta foi respondida',
  'Offered as a portfolio piece': 'Oferecido como amostra',
  'Shown as a portfolio piece': 'Mostrado como amostra',
  Signed: 'Assinado',
  'Passed its deadline': 'Passou o prazo',
  'A payment arrived that did not match': 'Chegou um pagamento que não correspondia',
  'Answered with a new chit': 'Respondido com um novo chit',
  'Marked delivered': 'Marcado como entregue',
  Reviewed: 'Avaliado',
  'Bounty opened': 'Recompensa aberta',
  'Bounty answered': 'Recompensa respondida',
  'Bounty paid': 'Recompensa paga',
  'Bounty payout failed': 'O pagamento da recompensa falhou',

  /* ---- the rest of the series, on the settled screen ---- */
  'Part of a series': 'Parte de uma série',
  'See what this answers': 'Ver a que isto responde',
  'What came after': 'O que veio a seguir',

  /* ---- ask for changes, before deciding whether to pay ---- */
  'Not quite right?': 'Não ficou bem?',
  'What needs to change': 'O que precisa de mudar',
  'e.g. can you make the logo bigger?': 'por ex. consegues fazer o logótipo maior?',
  'Ask for changes': 'Pedir alterações',
  'Sent — it is signed and on the record, and they will see it.': 'Enviado — está assinado e no registo, e vão vê-lo.',
  'Revision requested — {line}': 'Revisão pedida — {line}',
  '{n} revision requested so far': '{n} revisão pedida até agora',
  '{n} revisions requested so far': '{n} revisões pedidas até agora',
  'That is a real amount of extra work. A paid round is a fair way to ask for one.': 'Isso é bastante trabalho extra. Uma ronda paga é uma forma justa de a pedir.',
  'Propose a paid revision': 'Propor uma revisão paga',
  'Additional revision beyond what was agreed': 'Revisão adicional além do que foi acordado',
  ...
  'Could not save the PDF. Nothing was sent anywhere — try again.': 'Não foi possível guardar o PDF. Não foi enviado nada — tenta novamente.',
  ...
  'Weighted for recency and job size: {rating}': 'Ponderado pela recência e pela dimensão do trabalho: {rating}',
  'The average above treats every review the same, however old or however small the job. This one leans toward recent reviews and toward larger jobs — the same signed reviews, weighted rather than replaced.': 'A média acima trata cada avaliação da mesma forma, seja qual for a idade ou a dimensão do trabalho. Este número dá mais peso às avaliações recentes e aos trabalhos maiores — as mesmas avaliações assinadas, ponderadas em vez de substituídas.',
};
